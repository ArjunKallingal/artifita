...
const Login = () => {
    ...
    const submit = (e) => {
        ...
        if (!uname || !password) {
            ...
            if ((uname === storedUname && password === storedPass) || (uname === 'user' && password === '123')) {
                navigate('/home');
            }
            else {
            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-6 login-row1">
                        <h1>Wellcome Back</h1>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Itaque ullam corrupti ipsam. Quae culpa consectetur delectus repudiandae omnis quia voluptas aliquam similique fugiat. Consectetur ullam itaque facilis velit id ea?</p>
                        <Button className='mt-3' variant="outline-light" onClick={()=>navigate('/singup')}>Sign up</Button>
                    </div>
                        ...
                        <div className='login-border border'>
                            ...
                            <div className="text-center">
                                <form action="post" className='mt-5'>
                                    ...
                                    <Button className='mt-3' variant="warning" onClick={submit}>Sign in</Button>
                                </form>
                            </div>
                        </div>
                    </div>
